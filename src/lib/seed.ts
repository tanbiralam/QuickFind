...
// Ensure that environment variables are defined before accessing them
if (!process.env.UPSTASH_REDIS_URL || !process.env.UPSTASH_REDIS_TOKEN) {
  throw new Error("UPSTASH_REDIS_URL and UPSTASH_REDIS_TOKEN must be defined in environment variables.");
}
